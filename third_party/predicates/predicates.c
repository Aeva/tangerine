...
// BEGIN TANGERINE MOD -- Remove unused functionality
#if 0
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
#include <sys/time.h>
#endif
// END TANGERINE MOD -- Remove unused functionality
...
// BEGIN TANGERINE MOD -- Remove unused functionality
#if 0
// END TANGERINE MOD -- Remove unused functionality that doesn't build
...
// BEGIN TANGERINE MOD -- Remove unused functionality that doesn't build
#endif
// END TANGERINE MOD -- Remove unused functionality
